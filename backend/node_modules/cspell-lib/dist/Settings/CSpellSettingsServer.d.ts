import { Glob, CSpellSettingsWithSourceTrace, ImportFileRef } from '@cspell/cspell-types';
 ...
 */
declare function normalizeSettings(rawSettings: CSpellSettings, pathToSettingsFile: string): CSpellSettings;
...
export declare function searchForConfig(searchFrom?: string): Promise<CSpellSettings | undefined>;
export declare function loadConfig(file: string): Promise<CSpellSettings>;
