...
function getFollowersOfUser(username) {
  client.get('followers/ids', { screen_name: username }, (err, data, response) => {
    if (err) {
      console.log(err);
    } else {
...
function getFollowingOfUser(username) {
  client.get('friends/ids', { screen_name: username }, (err, data, response) => {
    if (err) {
      console.log(err);
    } else {
      // Do something with data
...
function searchQueryInUserTweets(username, query) {
  client.get('search/tweets', { q: `from:${username} ${query}` }, (err, data, response) => {
    if (err) {
      console.log(err);
    } else {
      // Do something with data
...
function getUserTimeline(username) {
  client.get('statuses/user_timeline', { screen_name: username }, (err, data, response) => {
    if (err) {
      console.log(err);
    } else {
      // Do something with data
...
function showUserDetails(username) {
  client.get('users/show', { screen_name: username }, (err, data, response) => {
    if (err) {
      console.log(err);
    } else {
      // Do something with data
